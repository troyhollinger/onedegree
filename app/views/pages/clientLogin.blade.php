...
From the <span class="bold">Home</span> tab you can access the
Tour Guide video in the bottom right tile.
This will give a brief overview of website
and access abilities.
            </p><br>
            <p class="text login-text">
                From the <span class="bold">Organizer</span> tab accounts can be
connected to the plan.
            </p><br>
            <p class="text login-text light">
                Please contact your advisor when you
link an account. Your accounts under our
management will be linked.
            </p><br>
            <p class="text login-text">
                <span class="bold">
                    Is this secure? :
        ...
        <div class="service-module">
            <button class="login-btn performance-reports"  onclick="window.open('https://advisor.envestnet.com/secure/login/envest.jsp', '_blank');">Performance
Reports</button><br><br>
            <p class="text login-text">This illustrates Quarterly and Daily
account performance and asset
allocation.</p><br>
<p class="text login-text">
    <span class="bold">Helpful hints on navigating website:</span>
The initial page, Market Summary,
shows recent market related
information.
</p><br>
<p class="text login-text">
    The Investment Reports section is
where you will find many different
reports.
</p><br><br>
        
            <p class="text login-text">
                <span class="bold">Forgot log-in information?</span><br>
Email <a href="mailto:admin@onedegreeadvisors.com?Subject=Forgot%20login" target="_top">admin@onedegreeadvisors.com</a>
Or Call 619 282-3288    
            </p>
        ...
        <div class="service-module">
            ...
            <p class="text text-login">
                This provides access to formal account
statements, trade confirmations and tax
forms for accounts held at TD
Ameritrade.
            </p><br>
            <p class="text text-login">
                <span class="bold">
                    Helpful hints on navigating website:
                </span>
From the top of any site page, you can
access a <span class="bold">site map</span> for an overview of
how the site is organized.
            </p><br>
            <p class="text text-login">
                In <span class="bold">Accounts</span>, you'll find the <span class="bold">Account
Center</span> which displays account
information for a single account,
including balances, positions, and
history.
            </p>
