...
<div class="container">
	...
	<div class="service-modules-container">
		...
		<div class="service-module">
			...
			<p class="text">Financial plans are monitored and updated on a regular basis to ensure that as your life changes, your plan stays current. For affluent families and complex issues, we offer advanced planning to help address estate tax issues, charitable giving, business planning and legacy topics that often require special attention. <span class="green-text">Wealth Management Video Explainer</span></p><br>
		</div>
